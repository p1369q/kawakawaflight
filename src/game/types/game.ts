...
export type FlightLocationId='grass'|'beach'|'mountain';
export type FlightStyleId='straight'|'high'|'fast';
export type FlightDifficulty='easy'|'normal'|'challenge';
export interface FlightRecord{id:string;planeId:string;location:FlightLocationId;style:FlightStyleId;distance:number;time:number;maxHeight:number;evaluation:string;createdAt:string}
