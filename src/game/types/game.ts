...
export interface SaveData{version:number;selection:PlaneSelection;bestDistance:number;bestStars:number;bestGoldStars:number;soundOn:boolean;hasSeenHowTo:boolean}
