...
export const missionCatalog2:MissionState2[]=[{id:'wood3',title:'木材を3こあつめよう',goal:3,progress:0,completed:false},{id:'wing1',title:'つばさを1こつくろう',goal:1,progress:0,completed:false},{id:'firstPlane',title:'はじめてのひこうきをつくろう',goal:1,progress:0,completed:false},{id:'fly10',title:'10mとばしてみよう',goal:10,progress:0,completed:false},{id:'engineSwap',title:'エンジンをつけかえよう',goal:1,progress:0,completed:false},{id:'quiz1',title:'クイズを1かいやってみよう',goal:1,progress:0,completed:false},{id:'quiz3',title:'3もんこたえよう',goal:3,progress:0,completed:false},{id:'quiz5',title:'5もんさいごまでやってみよう',goal:1,progress:0,completed:false},{id:'quizStreak3',title:'3もんれんぞくでこたえよう',goal:1,progress:0,completed:false},{id:'blueprint1',title:'せっけいずを1まいあつめよう',goal:1,progress:0,completed:false},{id:'firstFlight',title:'はじめて とばしてみよう',goal:1,progress:0,completed:false},{id:'flight3',title:'3かい とばしてみよう',goal:3,progress:0,completed:false},{id:'grassFlight',title:'そうげんで とばそう',goal:1,progress:0,completed:false},{id:'differentPlane',title:'ちがう ひこうきで とばそう',goal:1,progress:0,completed:false},{id:'newRecord',title:'新きろくを だそう',goal:1,progress:0,completed:false}];
