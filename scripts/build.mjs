...
const assetDirectory = `dist/assets/${assetVersion}`;
await mkdir(assetDirectory, { recursive: true });

await cp('dist/game', `${assetDirectory}/game`, { recursive: true });
await cp('dist/generated', `${assetDirectory}/generated`, { recursive: true });
...
await writeFile(`${assetDirectory}/main.js`, main);
await cp('src/ui/styles.css', `${assetDirectory}/styles.css`);
...
const moduleScript = `<script type="module" src="${base}assets/${assetVersion}/main.js" onerror="document.getElementById('startup-error').style.display='block'"></script>`;
const cssLink = `<link rel="stylesheet" href="${base}assets/${assetVersion}/styles.css">`;
